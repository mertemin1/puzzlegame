...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    Image(Vector2u size, const std::int* pixels);
    ...
    ///
    ////////////////////////////////////////////////////////////
    void resize(Vector2u size, const std::int* pixels);
    ...
    ///
    ////////////////////////////////////////////////////////////
    [[nodiscard]] std::optional<std::vector<std::int>> saveToMemory(std::string_view format) const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    void createMaskFromColor(Color color, std::int alpha = 0);
    ...
    ///
    ////////////////////////////////////////////////////////////
    [[nodiscard]] const std::int* getPixelsPtr() const;
...
private:
    ...
    std::vector<std::int> m_pixels; //!< Pixels of the image
};
