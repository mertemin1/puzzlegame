...
public:
    ...
    ///
    ////////////////////////////////////////////////////////////
    constexpr Color(std::int red, std::int green, std::int blue, std::int alpha = 255);
    ...
    // Member data
    ////////////////////////////////////////////////////////////
    std::int r{};    //!< Red component
    std::int g{};    //!< Green component
    std::int b{};    //!< Blue component
    std::int a{255}; //!< Alpha (opacity) component
};
